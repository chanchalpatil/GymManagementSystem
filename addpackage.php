  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <?php require_once 'includes/addpackage.inc.php'; ?>
        <?php
        ...
        <?php endif ?>
                    <div class="row mt">
                      <div class="col-lg-12">
                        <h4><i class="fa fa-angle-right"></i>EDIT PACKAGE DETAILS</h4>
                        <div class="form-panel">
                          <div class=" form">

                            <form class="cmxform form-horizontal style-form" id="addpackageForm" method="POST" action="includes/addpackage.inc.php">

                              <div class="form-group ">
                                <label for="cname" class="control-label col-lg-2"> Package ID </label>
                                <div class="col-lg-10">
                                  <input class=" form-control round-form" id="cname" type="number" value="<?php echo $Package_Id; ?>" name="packageid" required />
                                </div>
                              </div>
                              <div class="form-group ">
                                <label for="cname" class="control-label col-lg-2"> Package Type  </label>
                                <div class="col-lg-10">
                                  <input class=" form-control round-form" id="cname" type="text" value="<?php echo $Package_Name; ?>" name="packagename" required />
                                </div>
                              </div>
                              <div class="form-group ">
                                <label for="cname" class="control-label col-lg-2"> Amount(in INR) </label>
                                <div class="col-lg-10">
                                  <input class=" form-control round-form" id="cname" type="text" value="<?php echo $Amount; ?>" name="amount" required />
                                </div>
                              </div>
   ...
   <section>
    ...
    <footer class="site-footer">
      <div class="text-center">       
        <a href="addpackage.php" class="go-top">
